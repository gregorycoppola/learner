...
def add_subparser(subparsers):
    p = subparsers.add_parser("hybrid", help="Hybrid loss: CE for scan, verifiable for carry")
        ...
        with client.stream(
            ...
            for raw_line in resp.iter_lines():
                ...
                if event["type"] == "init":
                    ...
                    print()
                    print(f"{'Ep':<6} {'Loss':<12} {'Carry Acc':<12} "
                          f"{'Val Acc':<10} {'Best'}")
                    print("-" * 48)
                    ...
                    print()
                    print(f"Done.  Best val acc: {best_val:.1%}  "
                          f"Best carry acc: {best_carry:.1%}  "
